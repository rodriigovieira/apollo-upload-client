...
Initialize the client with a [terminating Apollo Link](https://www.apollographql.com/docs/react/api/link/introduction/#the-terminating-link) using the function [`createUploadLink`](./createUploadLink.js).
...
- [`createUploadLink.js`](./createUploadLink.js)
- [`formDataAppendFile.js`](./formDataAppendFile.js)
- [`isExtractableFile.js`](./isExtractableFile.js)
